...
const schema = yup.object({
  // movie: yup.string().required().max(100, "Maximum 100 characters."),
...
const AddShowTime = () => {
  ...
  return (
    <>
      <HeaderBreadcrumbs
        heading={isEdit ? "Edit Show Time" : "Add New Show Time"}
        links={[
          { name: "Dashboard", to: "/" },
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={4} sx={{ paddingTop: 0 }}>
            <Stack spacing={3}>
              ...
              >
                {!isEdit ? "Create Show Time" : "Save Changes"}
              </Button>
            </Stack>
          </Grid>
        </Grid>
